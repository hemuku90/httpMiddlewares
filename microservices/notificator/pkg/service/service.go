...
type NotificatorService interface {
	...
	SendMail(ctx context.Context, email string, content string) error
}

type basicNotificatorService struct{}

func (b *basicNotificatorService) SendMail(ctx context.Context, email string, content string) (e0 error) {
	// TODO implement the business logic of SendMail
	return e0
}
